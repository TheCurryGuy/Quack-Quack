...
export default function SaveReviewRestoreSection({ onOpenInstall }: SaveReviewRestoreSectionProps) {
  const [activeFeature, setActiveFeature] = useState<FeatureData | undefined>(features[0])
  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        ...
        >
          {"Enter the arena to Challenge your skills,Code a winning solution, and Conquer the competition."}
        </p>
      </div>
